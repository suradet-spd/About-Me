                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="img_list_{{ $md_port["portfolio_seq"] }}" class="carousel slide" data-ride="carousel">
                            ...
                            <a class="carousel-control-prev" href="#img_list_{{ $md_port["portfolio_seq"] }}" data-slide="prev">
                              <span class="carousel-control-prev-icon"></span>
                            </a>
                            <a class="carousel-control-next" href="#img_list_{{ $md_port["portfolio_seq"] }}" data-slide="next">
